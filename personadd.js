...
var getQuery = function(){
	...
	return "ajax=true&fname=" + encodeURI(fname) + "&surname=" + encodeURI(surname) + "&tagid=" + encodeURI(tagid) + "&number=" + encodeURI(number)+ "&check1=" + encodeURI(check1)+ "&check2=" + encodeURI(check2); 
}
...
{
	var x = 	new AO("add_person.php",qs);
		x.onload = function()
		{
